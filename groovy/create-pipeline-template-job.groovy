...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/shaival-cloudbees-ci-training/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>shaival-cloudbees-ci-training</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>shaival-cloudbees-ci-training</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/shaival-cloudbees-ci-training/pipeline-template-catalog.git</repositoryUrl>
              <traits>
